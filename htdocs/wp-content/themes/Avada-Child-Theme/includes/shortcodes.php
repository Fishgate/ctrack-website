...
function ct_product_icon_func($atts) {
	$atts = shortcode_atts( array(
		'icon' => '#',
		'price' => 'false',
		'monthly' => '#',
	...
	<div>
		<table style="margin: 0 auto;" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<?php if(isset($atts['price']) && $atts['price'] === 'true') : ?>
				<td class="product-price" valign="middle"><h2>R<?php echo $atts['monthly']; ?>*<small>monthly</small></h2></td>
				<?php endif; ?>
			</tr>
...
add_shortcode('ct_product_icon','ct_product_icon_func');
 ...
 */
function ct_accordian_wrapper_func($atts, $content = "") {
	$atts = shortcode_atts(array(
		'class' => ''
	), $atts);
	...
	<div class="accordian ct_accordian wrapper <?php echo $atts['class']; ?>">
...
add_shortcode('ct_accordian','ct_accordian_wrapper_func');


/**
 * Individual shortcode toggle item
 */
function ct_accordian_toggle_func($atts, $content = "") {
	$atts= shortcode_atts(array(
		'icon' => '#',
		'title' => '#'
	), $atts);
...
add_shortcode('ct_toggle','ct_accordian_toggle_func');
